...
51	        "You&apos;re on fire! 🔥 Your weekly trading streak is at 5 days. Keep it up for a bonus 500 XP reward!",
...
91	                <Bot className="h-4 w-4 text-white" />
92	              </div>
...
131	                    ? "bg-gradient-to-r from-[#1E90FF] to-[#1E90FF]/80 text-white"
...
141	              <div className="flex items-center gap-1 rounded-2xl bg-secondary px-4 py-3">
...
169	                type="text"
170	                value={input}
171	                onChange={(e) => setInput(e.target.value)}
